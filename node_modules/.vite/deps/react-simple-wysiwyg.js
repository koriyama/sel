  ...
  return React.useMemo(function() {
    ...
    function onChange(event) {
      ...
      if (elementHtml !== htmlRef.current) {
        (_b = (_a2 = restRef.current).onChange) === null || _b === void 0 ? void 0 : _b.call(_a2, __assign(__assign({}, event), { target: {
          value: elementHtml,
          name: rest.name
        } }));
      }
    ...
    return React.createElement(tagName || "div", __assign(__assign({}, rest), { className, contentEditable: !disabled, dangerouslySetInnerHTML: { __html: value }, onBlur: function(e2) {
...
function createButton(title, content, command) {
  ...
  function ButtonFactory(props) {
    ...
    return React.createElement("button", __assign({ type: "button", title }, props, { className: "rsw-btn", onMouseDown: onAction, "data-active": active }), content);
  }
}
...
function createDropdown(title, items) {
  ...
  function DropdownFactory(props) {
    ...
    return React.createElement(Dropdown, __assign({}, props, { onChange, title, items, selected: activeIndex }));
...
function HtmlButton(_a) {
  ...
  return React.createElement("button", __assign({ type: "button", title: "HTML mode", className: "rsw-btn", onClick, "data-active": editorState.htmlMode }, rest), "</>");
}
function Separator() {
  var editorState = useEditorState();
  if (editorState.htmlMode) {
